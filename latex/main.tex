...
\begin{titlepage}
    ...
    \begin{minipage}{0.48\textwidth}
        ...
        1. Lead Builder \& Master Scribe: \textbf{User}\\
        2. Lead Measurer \& Verifier: \textbf{Teammate 2}\\
        3. Lead Skeptic \& Hardware Auditor: \textbf{Teammate 3}\\
...
\input{sections/00_intro_toolbox}
\newpage

\input{sections/01_experiment1}
\newpage

\input{sections/02_experiment2}
\newpage

\input{sections/03_experiment3}
\newpage

\input{sections/04_experiment4}
\newpage

\input{sections/05_experiment5}
\newpage

\input{sections/06_experiment6}
\newpage

\input{sections/07_final_challenge}
\newpage

\input{sections/08_summary_comparison}
\newpage

\input{sections/09_biggest_surprise}
\newpage

\input{sections/10_team_reflection}
\newpage
